...
function App() {
  ...
  useEffect(() => {
    setTotalPages(Math.ceil(filteredItems ? filteredItems.length / ITEM_PER_PAGE : items.length / ITEM_PER_PAGE))
  },[filteredItems])
  ...
  return (
    <Routes>
      ...
      <Route exact path="/add-link" element={<AddLinkPage items={items} filteredText={filteredText} setItems={setItems}/>} />
