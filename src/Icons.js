...
const LeftArrowIcon = () => {
    return (
        <svg width="16" height="27" viewBox="0 0 16 27" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M14.162 25.5L2.16205 13.5L14.162 1.5" stroke="#8A8A8A" strokeWidth="2.7" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
    )
}
...
const RightArrowIcon = () => {
    return (
        <svg width="15" height="27" viewBox="0 0 15 27" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M1.51459 25.5L13.5146 13.5L1.51459 1.5" stroke="#8A8A8A" strokeWidth="2.7" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
